...
//	     	 response.sendRedirect(request.getContextPath() + "/Confirmatio.html");
			   return;
		}
		...
		boolean che=RegistrationDAO.checkAlre(model);
		if(che) {
...
//			 response.setContentType("text/html");
//     	    out.println("<h3 style=\"color: red; margin-left: 50%\"> User Register Sucessfully </h3>;");
//     	    RequestDispatcher rd=request.getRequestDispatcher("/REGISTRATION.html");
//     	    rd.include(request, response);
